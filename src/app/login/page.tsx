    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground">Welcome back to TaskZen</h1>
          <p className="text-muted-foreground">Log in to manage your projects and tasks.</p>
        </div>
        <LoginForm />
